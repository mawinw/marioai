...
class DQNAgent:
    ...
    def __init__(self, state_size, action_size):
        ...
        self.model = self.build_simple_conv2d()
...
# #agent.model.output
# plot_model(agent.model, to_file='model_vgglike_2.png', show_shapes=True, show_layer_names=True)
# 
...
agent.save_model_formatting('simple_conv2d_model')
